...
export default function NavbarComponent() {
  ...
  return (
    <>
      <div
        className={`sticky top-0 left-0 z-20 max-md:px-4 max-md:py-8 py-12 px-16 max-md:bg-white md:max-lg:backdrop-blur mb-5`}
      >
        <nav className="flex justify-between">
          <div className="brand-logo">
            <Image
              onClick={() => navigate.push("/")}
              className="max-md:w-[32px] self-center cursor-pointer"
              src={BrandLogo}
              alt="brand-logo"
              priority
            />
